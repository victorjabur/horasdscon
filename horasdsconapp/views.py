...
from horasdscon import settings
...
from horasdscon.horasdsconapp.models import CredentialsModel, FlowModel
from apiclient.discovery import build

from django.http import HttpResponseRedirect
from django.shortcuts import render_to_response

STEP2_URI = settings.util.getEntry('google_oauth', 'REDIRECT_URI', settings.PYTHON_CONF)
